...
<html>
    ...
    <body>
        ...
        <p>Please provide the student's first, middle, and last names and then enter their scores for homework assignments, quizzes, midterm and final project assessments. Each score should range between 0 and 100 and may include decimal values.</p>
        </div>
        <form action="add_entry.php" method="post">
            ...
            <table>
                ...
                <tr>
                    <td><input type='number' name='hw1' min='0' max='100' step='0.01'></br>Hw 1</td>
                    <td><input type='number' name='hw2' min='0' max='100' step='0.01'></br>Hw 2</td>
                    <td><input type='number' name='hw3' min='0' max='100' step='0.01'></br>Hw 3</td>
                    <td><input type='number' name='hw4' min='0' max='100' step='0.01'></br>Hw 4</td>
                    <td><input type='number' name='hw5' min='0' max='100' step='0.01'></br>Hw 5</td>
                </tr>
            </table></br>
            <table>
                <tr>
                ...
                <tr>
                    <td><input type='number' name='q1' min='0' max='100' step='0.01'></br>Quiz 1</td>
                    <td><input type='number' name='q2' min='0' max='100' step='0.01'></br>Quiz 2</td>
                    <td><input type='number' name='q3' min='0' max='100' step='0.01'></br>Quiz 3</td>
                    <td><input type='number' name='q4' min='0' max='100' step='0.01'></br>Quiz 4</td>
                    <td><input type='number' name='q5' min='0' max='100' step='0.01'></br>Quiz 5</td>
                </tr>
            </table></br>
            <table>
                <tr>
                ...
                <tr>
                    <td><input type='number' name='midterm' min='0' max='100' step='0.01'></br>Midterm</td>
                    <td><input type='number' name='finalProject' min='0' max='100' step='0.01'></br>Final</td>
                </tr>
            </table></br>
            <table>
                <tr>
